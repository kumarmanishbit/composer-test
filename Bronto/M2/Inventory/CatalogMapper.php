...
namespace Bronto\M2\Inventory;

class CatalogMapper extends \Bronto\M2\Product\CatalogMapperAbstract
{
    ...
    /**
     * @param \Bronto\M2\Product\ExtensionAbstract $extension
     * @param \Bronto\M2\Core\Catalog\ProductCacheInterface $products
     * @param \Bronto\M2\Product\CatalogMapperManagerInterface $manager
     */
    public function __construct(
        \Bronto\M2\Product\ExtensionAbstract $extension,
        \Bronto\M2\Core\Catalog\ProductCacheInterface $products,
        \Bronto\M2\Product\CatalogMapperManagerInterface $manager
    ) {
    ...
    protected function _pushItem($item, $products, $storeId)
    {
        ...
        $event = new \Bronto\M2\Core\DataObject(['product' => $product]);
