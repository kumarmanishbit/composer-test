...
{
    const EVENT_NAME = "bronto_product_extra_fields";
    const EVENT_DEFAULT_FIELDS = "bronto_product_default_fields";
    const EVENT_CUSTOM_FIELDS = "bronto_product_custom_fields";
    const EVENT_ATTRIBUTE_FIELDS = "bronto_product_attribute_fields";
    ...
    {
        $container = new \Bronto\M2\Core\DataObject(['fields' => []]);
