...
{
    const XML_PATH_ENABLED = 'bronto/coupon/extensions/settings/enabled';
    const XML_PATH_MESSAGE = 'bronto/coupon/extensions/settings/%s_message';
    const XML_PATH_LINK_CONTENT = 'bronto/coupon/extensions/settings/link_text';
    const XML_PATH_COUPON_PARAM = 'bronto/coupon/extensions/settings/coupon_param';
    const XML_PATH_INVALID_PARAM = 'bronto/coupon/extensions/settings/invalid_param';
