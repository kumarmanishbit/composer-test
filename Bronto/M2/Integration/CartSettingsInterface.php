...
{
    const XML_PATH_RECOVERY_ENABLED = 'bronto/integration/extensions/cart_recovery/enabled';
    const XML_PATH_RECOVERY_EMBED = 'bronto/integration/extensions/cart_recovery/embed_code';
    const XML_PATH_RECOVERY_TAX_INCLUDED = 'bronto/integration/extensions/cart_recovery/tax_included';
