...
{
    const XML_PATH_POPUP_ENABLED = 'bronto/integration/extensions/popup_manager/enabled';
    const XML_PATH_POPUP_DOMAINS = 'bronto/integration/extensions/popup_manager/popups';
    const XML_PATH_POPUP_CREATE = 'bronto/integration/extensions/popup_manager/createSubscribers';
