...
abstract class ExtensionAbstract extends \Bronto\M2\Connector\Discovery\AdvancedExtensionAbstract implements \Bronto\M2\Connector\Discovery\GroupInterface, \Bronto\M2\Connector\Discovery\TransformEventInterface
{
    /** @var \Bronto\M2\Core\Sales\OrderCacheInterface */
    protected $_orderRepo;

    /** @var \Bronto\M2\Core\Customer\CacheInterface */
    protected $_customerRepo;

    /** @var \Bronto\M2\Connector\Event\PushLogic */
    protected $_orderPush;

    /** @var \Bronto\M2\Contact\Event\GuestFromOrder */
    ...
    public function __construct(
        ...
        $this->_orderSource = new \Bronto\M2\Contact\Event\GuestFromOrder($this->_helper);
        $this->_orderPush = new \Bronto\M2\Connector\Event\PushLogic(
            $queueManager,
            $connectorSettings,
            $helper,
            $platform,
    ...
    {
        /** @var \Bronto\M2\Connector\Discovery\Endpoint $endpoint */
