...
{
    /** @var \Bronto\M2\Contact\AttributeSettingsInterface  */
    protected $_settings;

    /**
     * @param \Bronto\M2\Contact\AttributeSettingsInterface $settings
     */
    public function __construct(
        \Bronto\M2\Contact\AttributeSettingsInterface $settings
    ) {
