...
{
    const XML_PATH_CLEANUP_THRESHOLD = 'bronto/advanced/extensions/settings/sendThreshold';
    const XML_PATH_MAGENTO_BCC = 'bronto/email/extensions/transactional/magentoBcc';
    const XML_PATH_MESSAGE_ENABLED = 'bronto/email/extensions/%s/enabled';
    const XML_PATH_MESSAGE_DISPLAY = 'bronto/email/extensions/%s/displaySymbol';
    const XML_PATH_MESSAGE_INCLUDE_TAX = 'bronto/email/extensions/%s/includeTax';
    const XML_PATH_MESSAGE_AUTHENTICATION = 'bronto/email/extensions/%s/authentication';
    const XML_PATH_MESSAGE_FATIGUE_OVERRIDE = 'bronto/email/extensions/%s/fatigueOverride';
    const XML_PATH_MESSAGE_REPLY_TRACKING = 'bronto/email/extensions/%s/replyTracking';
    const XML_PATH_MESSAGE_REPLY_TO = 'bronto/email/extensions/%s/replyTo';
    const XML_PATH_MESSAGE_SENDER = 'bronto/email/extensions/%s/sender';
    const XML_PATH_MESSAGE_AUDIENCE = 'bronto/email/extensions/%s/targetAudience';
    const XML_PATH_MESSAGE_EXCLUSION_LISTS = 'bronto/email/extensions/%s/exclusionLists';
    const XML_PATH_POSTPURCHASE_FIELD = 'bronto/email/extensions/%s/%s';

    const XML_PATH_OBJECT_PATH = 'bronto/email/objects/%s/%s';
    const XML_PATH_REORDER_PATH = 'bronto/email/objects/reorder/%';
    const XML_PATH_CARETIP_PATH = 'bronto/email/objects/caretip/%';
    const XML_PATH_CART_PATH = 'bronto/email/objects/cart/%';
    const XML_PATH_WISHLIST_PATH = 'bronto/email/objects/wishlist/%';
    const XML_PATH_MAPPING_PATH = 'bronto/email/objects/mapping/%';
    const XML_PATH_LOOKUP_PATH = 'bronto/email/objects/reverse/%';
    const FILTER_EVENTS = 'bronto_email_template_filter';
