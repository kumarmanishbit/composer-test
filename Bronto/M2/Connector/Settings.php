...
class Settings extends \Bronto\M2\Core\Config\ContainerAbstract implements \Bronto\M2\Connector\SettingsInterface
{
    /**
     * @see parent
     */
    ...
    /**
     *
     * @see \Bronto\M2\Connector\SettingsInterface::getEik
     * @param string $scope
     * @param null $scopeId
     * @return string
     */
    ...
    /**
     * @see \Bronto\M2\Connector\SettingsInterface::getCustomUrl
    ...
    /**
     *
     * @see \Bronto\M2\Connector\SettingsInterface::getServiceUrl
     * @param string $scope
     * @param null $scopeId
     * @return string
     */
    ...
    /**
     * {@inheritDoc}
     * @see \Bronto\M2\Connector\SettingsInterface::getBatchSize()
     */
