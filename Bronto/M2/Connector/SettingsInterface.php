...
{
    const XML_PATH_SITEID = 'bronto/general/settings/siteId';
    const XML_PATH_MASKID = 'bronto/general/settings/maskId';
    const XML_PATH_EIK = 'bronto/general/settings/externalInstallKey';
    const XML_PATH_CUSTOM_URL = 'bronto_local/general/custom_url';
    const XML_PATH_ORDER_SERVICE = 'bronto/general/features/enableOrderService';
    const XML_PATH_TEST_MODE = 'bronto/advanced/extensions/testImport/enabled';
    const XML_PATH_DISABLE_FLUSH = 'bronto/advanced/extensions/testImport/disableFlush';
    const XML_PATH_BATCH_SIZE = 'bronto/advanced/extensions/performance/batchSize';
    const XML_PATH_BROWSE_RECOVERY = 'brontosoftware/integration/extensions/browse_recovery/enabled';
    const XML_PATH_CART_RECOVERY = 'brontosoftware/integration/extensions/cart_recovery/enabled';
    const XML_PATH_CART_RECOVERY_API_TOGGLE = 'brontosoftware/integration/extensions/cart_recovery/toggle_api';

    const XML_PATH_TOGGLE_PREFIX = 'bronto/toggle/%s';

    const SERVICE_URL_OVERRIDE_KEY = 'BRONTO_SERVICE_URL';
    const SERVICE_URL = 'https://fiddler.brontops.com';
