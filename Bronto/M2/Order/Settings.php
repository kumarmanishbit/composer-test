...
class Settings extends \Bronto\M2\Core\Config\ContainerAbstract implements SettingsInterface
{
    ...
    /** @var \Bronto\M2\Core\Config\ScopedInterface */
    protected $_productRepo;

    /** @var \Bronto\M2\Core\Directory\CurrencyManagerInterface */
    protected $currencies;

    /** @var  \Bronto\M2\Core\Directory\Currency|null */
    protected $currency;
    ...
    public function createShippingItem($order)
    {
        ...
        if ($this->isIncludeShipping('store', $order->getStoreId()) && $order->hasShipments()) {
            ...
            $itemObject = new \Bronto\M2\Core\DataObject([
    ...
    /**
     * @see \Bronto\M2\Order\SettingsInterface::isShipped
     */
    ...
    /**
     * @see parent
     * @param \Magento\Sales\Api\Data\OrderItemInterface|\Bronto\M2\Core\DataObject $lineItem
    ...
    private function validateLineItem($lineItem)
    {
        if (!($lineItem instanceof AbstractItem) &&
            ...
            $message = 'Line item passed must be an instance of \Magento\Quote\Model\Quote\Item\AbstractItem, '
                . '\Magento\Sales\Api\Data\OrderItemInterface, or \Bronto\M2\Core\DataObject. %s given.';
