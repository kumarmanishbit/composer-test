...
use Bronto\M2\Connector\Discovery\AdvancedExtensionAbstract;
use Bronto\M2\Connector\Event\SourceInterface;
use Bronto\M2\Core\Sales\OrderCacheInterface;
...
abstract class ExtensionAbstract
    extends \Bronto\M2\Connector\Discovery\AdvancedExtensionAbstract
    implements \Bronto\M2\Connector\Discovery\GroupInterface,
        \Bronto\M2\Connector\Discovery\TransformEventInterface,
        \Bronto\M2\Email\FilterEventInterface
{

    use \Bronto\M2\Email\FilterEventTrait;

    const CONNECTOR_CONTROLLER_NAME = 'connector';

    /** @var \Bronto\M2\Core\Catalog\ProductAttributeCacheInterface */
    protected $_attributes;

    /** @var \Bronto\M2\Core\Sales\OrderStatusesInterface */
    protected $_statuses;

    /** @var \Bronto\M2\Core\Sales\OrderCacheInterface */
    protected $_orderRepo;

    /** @var  \Bronto\M2\Helper\Data */
    ...
    public function __construct(
        ...
        \Bronto\M2\Core\Sales\OrderCacheInterface $orderRepo,//TODO:Replace this with Magento's order repo (added below)
    ...
    /**
     * @see \Bronto\M2\Connector\Discovery\ExtensionPushEventAbstract::pushChanges
     */
    ...
    public function apply(array $message, array $templateVars = [], $forceContext)
    {
        ...
        /** @var \Bronto\M2\Order\SettingsInterface $helper */
