...
abstract class ExtensionAbstract implements \Bronto\M2\Connector\Discovery\AdvancedExtensionInterface
{
    /** @var \Bronto\M2\Notification\SettingsInterface */
    protected $_settings;

    /** @var \Bronto\M2\Notification\ManagerInterface */
    protected $_manager;
     ...
     * @param \Bronto\M2\Notification\SettingsInterface $settings
     * @param \Bronto\M2\Notification\ManagerInterface $manager
     */
    public function __construct(
        \Bronto\M2\Connector\SettingsInterface $connectorSettings,
        \Bronto\M2\Notification\SettingsInterface $settings,
        \Bronto\M2\Notification\ManagerInterface $manager
    ) {
