...
class ProductCacheBridge extends \Bronto\M2\Core\Catalog\ProductCacheAbstract
{
    protected $_repo;
    protected $_typePool;
     ...
     * @param \Bronto\M2\Core\Catalog\ImageHelperInterface $imageHelper
     * @param \Bronto\M2\Core\Store\ManagerInterface $storeManager
     * @param \Bronto\M2\Core\Catalog\ProductCategoryResolverInterface $resolver
    ...
    public function __construct(
        ...
        \Bronto\M2\Core\Catalog\ImageHelperInterface $imageHelper,
        \Bronto\M2\Core\Store\ManagerInterface $storeManager,
        \Bronto\M2\Core\Catalog\ProductCategoryResolverInterface $resolver,
