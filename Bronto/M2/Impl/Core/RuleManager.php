...
class RuleManager implements \Bronto\M2\Core\Sales\RuleManagerInterface
{
     ...
     * @see parent
     */
    public function getBySource(\Bronto\M2\Connector\Discovery\Source $source, $onlyPools = true)
    {
