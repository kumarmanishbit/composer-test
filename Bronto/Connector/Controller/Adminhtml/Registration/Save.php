...
class Save extends \Bronto\Connector\Controller\Adminhtml\Registration
{
    ...
    public function execute()
    {
        if (!$this->getRequest()->isPost()) {
            ...
            try {
                ...
                $this->_getSession()->setData('brontoconnector_registration_form_data', $this->getRequest()->getParams());
                $this->_forward('new');
