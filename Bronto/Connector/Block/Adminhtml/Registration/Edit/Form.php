...
namespace Bronto\Connector\Block\Adminhtml\Registration\Edit;
...
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addType('scope', '\Bronto\Connector\Block\Adminhtml\Registration\Edit\Form\Element\Scope');
        ...
        $this->setForm($form);
        $this->_eventManager->dispatch('adminhtml_system_brontoconnector_edit_prepare_form', ['form' => $form]);
