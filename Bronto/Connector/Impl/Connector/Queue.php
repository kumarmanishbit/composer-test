...
namespace Bronto\Connector\Impl\Connector;

class Queue implements \Bronto\M2\Connector\QueueManagerInterface
{
    protected $_time;
    ...
    /**
     * @var \Bronto\Connector\Helper\Queue
     */
    protected $_helper;
    ...
    /**
     * @param \Bronto\Connector\Model\EventFactory $eventFactory
     * @param \Bronto\Connector\Model\ResourceModel\Event\CollectionFactory $eventData
     */
    public function __construct(
        \Magento\Framework\Stdlib\DateTime\DateTime $time,
        \Bronto\Connector\Model\EventFactory $eventFactory,
        \Bronto\Connector\Model\ResourceModel\Event\CollectionFactory $eventData,
        \Bronto\Connector\Helper\Data $helper
    ) {
        $this->_time = $time;
    ...
    public function save($newEventData)
    {
        ...
        /** @var \Bronto\Connector\Model\Event $queue */
     ...
     * @see parent
     */
    public function delete(\Bronto\M2\Connector\QueueInterface $queue)
    {
        $queue->delete();
    }
