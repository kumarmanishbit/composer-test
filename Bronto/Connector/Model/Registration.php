...
class Registration extends \Magento\Framework\Model\AbstractModel implements \Bronto\M2\Connector\RegistrationInterface
{
    const PLATFORM_SUFFIX = 'bronto';
    ...
    {
        $this->_init('Bronto\Connector\Model\ResourceModel\Registration');
    }
