define([
    ...
    'brontoStorage'
], function ($, Component, ko, customerData, brontoStorage) {
    ...
    ko.bindingHandlers.btaBinding = {
        init: function (element, valueAccessor, allBindings, viewModel, bindingContext) {
            ...
            var tid = brontoStorage.get(TID_STORAGE_KEY)
            ...
            if (siteId && typeof siteId != 'undefined' && tid) {
                ...
                brontoStorage.remove(TID_STORAGE_KEY);
            }
        }
    }
    ...
    var storeTidValue = function () {
        ...
        if (tid) {
            brontoStorage.set(TID_STORAGE_KEY, tid);
        }
    }
