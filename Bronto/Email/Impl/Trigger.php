...
namespace Bronto\Email\Impl;

class Trigger implements \Bronto\M2\Email\TriggerManagerInterface
{
    ...
    /**
     * @param \Bronto\Email\Model\ResourceModel\Trigger\CollectionFactory $dataFactory
     * @param \Bronto\Email\Model\TriggerFactory $triggerFactory
     */
    public function __construct(
        \Bronto\Email\Model\ResourceModel\Trigger\CollectionFactory $dataFactory,
        \Bronto\Email\Model\TriggerFactory $triggerFactory,
     ...
     * @see parent
     */
    public function save(\Bronto\M2\Email\TriggerInterface $trigger)
    {
        $trigger->save();
    }
     ...
     * @see parent
     */
    public function delete(\Bronto\M2\Email\TriggerInterface $trigger)
    {
        $trigger->delete();
    }
     ...
     * @return \Bronto\Email\Model\ResourceModel\Trigger\Collection
     */
