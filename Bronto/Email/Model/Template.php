...
class Template implements \Magento\Framework\Mail\TemplateInterface
{
    ...
    /**
     * @param \Bront\Magento\Email\SettingsInterface $helper
    ...
    public function setOptions(array $options)
    {
        ...
        if (array_key_exists('forceMagento', $this->_vars) || empty($this->_data) || !$this->_data['enabled']) {
            $original = $this->_objectManager->create(\Bronto\Email\Model\Settings::TEMPLATE, [
    ...
    {
        return implode(':', [\Bronto\Email\Model\Settings::BRONTO_ID, $this->_options['store']]);
    }
    ...
    public function processTemplate()
    {
        ...
        if ($this->_data['isSendingQueued']) {
            ...
            if (!empty($extraFields)) {
                ...
                /** @var \Bronto\Email\Model\Template\Filter $filter */
