...
class Trigger extends \Magento\Framework\Model\AbstractModel implements \Bronto\M2\Email\TriggerInterface
{
    /**
     * @see parent
     */
    ...
    {
        $this->_init('Bronto\Email\Model\ResourceModel\Trigger');
    }
