...
use Bronto\M2\Impl\Core\Meta;
use Bronto\Serialize\Json\Standard as Serializer;
use Bronto\Transfer\Adapter;
use Bronto\Transfer\Response;
...
class VersionFeed extends \Magento\Framework\Model\AbstractModel
{
    ...
    const CACHE_KEY_LASTCHECK = 'bronto_notifications_lastcheck';
